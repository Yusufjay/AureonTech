...
// Jika sudah login, tidak perlu daftar, lempar ke admin/index
...
if (isset($_POST['register'])) {
    ...
    elseif ($password_raw !== $password_confirm) {
        ...
        if (mysqli_num_rows($cek_user) > 0) {
            ...
            // Enkripsi password menggunakan MD5 (Sesuai dengan logic login.php Anda)
            $password_hash = md5($password_raw);

            // Masukkan ke database
            // Pastikan struktur tabel Anda: id (auto_increment), username, password
            $query_insert = "INSERT INTO users (username, password) VALUES ('$username', '$password_hash')";
...
<head>
    ...
    <title>Daftar Akun - Aureon Tech</title>
    ...
    <style>
        ...
        @media (max-width: 992px) {
            .login-container { flex-direction: column; text-align: center; gap: 30px; }
...
<header class="login-header">
    <a href="index.php" class="brand-logo">
        ...
        <span class="login-title">Daftar</span>
    </a>
    <a href="#" class="text-primary fw-bold text-decoration-none">Butuh Bantuan?</a>
</header>
...
<div class="login-wrapper">
    <div class="login-container">
        <div class="hero-content">
            ...
            <div class="hero-slogan">Gabung Sekarang</div>
            <div class="hero-subtext">Nikmati promo & diskon member eksklusif</div>
        </div>
        ...
        <div class="login-box">
            ...
            <form method="POST">
                <div class="mb-3">
                    <input type="text" name="user" class="form-control p-3" placeholder="Username Baru" required>
                </div>
                <div class="mb-3">
                    <input type="password" name="pass" class="form-control p-3" placeholder="Password" required>
                </div>
                <div class="mb-3">
                    <input type="password" name="pass_confirm" class="form-control p-3" placeholder="Konfirmasi Password" required>
                </div>
...
>>>>>>> 90b4e164dd971cf78db8f83d52120968490b41c9
</html>